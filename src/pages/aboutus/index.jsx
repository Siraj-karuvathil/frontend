...
import {CookLogo,Abtarabi,Abtp1,Abtqualt,Abtinnov,Abtdev,Abttrust,ckv3 } from '../../Assets'
    ...
    <>
      <section className="relative">
        ...
        <div className="absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <img src={CookLogo} alt='' width="353px" height="167px" />
        </div>
      </section>
      ...
      <section className='w-10/12 mx-auto grid grid-cols-1 md:grid-cols-3 md:py-10'>
        ...
        <div data-aos="fade-right" className="h-full">
          <img src={Abtp1} alt='who we are' className='md:h-full' />
        </div>
      </section>
      ...
      <section className="py-10 px-50 ownerBackground">
        <div className="w-11/12 mx-auto py-10">
          <video src={ckv3} type="video/mp4" controls
          autoPlay
          loop 
          muted
          controlsList="nodownload" className='w-full rounded-[2rem]'>
          </video>
        </div>
      </section>
      ...
      <section className='abtVision relative'>
       ...
       <div className='w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2'>
          <div className=' lg:w-[80%] max-w-lg z-20 lg:ml-8 '>
                <img className='' src={Abtarabi} alt="image of the company owner" width='100%' />
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 w-10/12 mx-auto'>
                ...
                <div className='grid grid-cols-2 grid-rows-2 gap-5 xs:py-10 md:py-24 place-items-center'>
                    <div className='grid place-items-center'>
                      <img src={Abttrust} alt='Trust' width='120px' height='120px inline-block' />
                      <h1 className='pt-3 text-xl' >{t('valuep1')}</h1>
                    </div>
                    <div className='grid place-items-center'>
                        <img src={Abtinnov} alt='Innovation' width='80px' height='80px' />
                        <h1 className='pt-3 text-xl'>{t('valuep2')}</h1>
                    </div>
                    <div className='grid place-items-center'>
                      <img src={Abtdev} alt='Development' width='80px' height='80px' />
                      <h1 className='pt-3 text-xl'>{t('valuep3')}</h1>
                    </div>
                    <div className='grid place-items-center'>
                        <img src={Abtqualt} alt='Quality' width='80px' height='80px' />
